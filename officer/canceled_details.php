<?php
	...
	if (!isset($_GET['id'])) {
		# code...
		header("Location: canceled_indents.php");
	}
	...
	if($_SESSION['user_name']!= $temp['passed_by_id']){
		header("Location: canceled_indents.php");
		exit();
	}
	$result=mysqli_query($link,"SELECT * FROM indent WHERE id=".$_GET['id']." AND status=0");
	...
	<div class="row" style="padding-right: 20px; padding-left: 20px; padding-top: 230px">
		...
		<div class="panel panel-default">
			<div class="panel-heading">CANCELED ITEMS</div>
			<div class="panel-body">
