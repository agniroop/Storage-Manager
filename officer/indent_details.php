<?php
	...
	if (!isset($_GET['id'])) {
		# code...
		header("Location: approve_indent.php");
	}
	...
	$result=mysqli_query($link,"SELECT * FROM indent WHERE id=".$_GET['id']." AND status=1");
		...
		<div class="panel panel-default">
			...
			?>	
				...
				<?php } ?>
					...
					<input type="submit" name="submit" class="btn btn-block btn-success " value="Approve indent">
